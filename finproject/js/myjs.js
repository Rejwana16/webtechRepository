...
function Trainer()
{
  var checkTrainer = document.getElementById("tname").value;
  var xhttp = new XMLHttpRequest();
  xhttp.onreadystatechange = function() 
  {
    if (this.readyState == 4 && this.status == 200) 
    {
      document.getElementById("trainerInfo").innerHTML = this.responseText;
    }
  };
  xhttp.open("POST", "/finproject/control/trainerHandle.php?checkTrainer="+checkTrainer, true);
  xhttp.send();
}
...
function MyAjaxFunc() 
{
  ...
  xhttp.open("POST", "/finproject/control/formHandle.php?checkUserName="+checkUserName, true);
  xhttp.send();
}
